...
import bo.edu.ucb.darkgod.examen.Servicios.Cifrado;
...
public class ListaAnunciosActivity extends AppCompatActivity {
    ...
    private AnuncioServicio servicios;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        servicios=new AnuncioServicio(this,this);
        lista = new ArrayList<>();
        ...
        imgOrden.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("ListaAnunciosActivity", orden+"false es des");
                servicios.obtenerAnuncios(pagina_actual,clave,tipo,orden,adaptadorLista,btnAtras,btnAdelante,tvPagina);
            }
        });
